#  ✅ React ToDo App with API | [DEMO](https://nadiiabulmak.github.io/react_todo_app-complete_with_api/)
...
```bash
git clone https://github.com/NadiiaBulmak/react_todo_app-complete_with_api
```

### 2. Navigate to the project directory

```bash
cd react_todo_app-complete_with_api
```
...
The application will be available at  http://localhost:5173/react_todo_app-complete_with_api/
